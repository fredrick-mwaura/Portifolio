...
const Card = ({ title, content }) => {
  return (
      <div
          className="bg-amber-200 shadow-lg rounded-lg p-4 transition-transform duration-300 transform hover:translate-y-2 hover:bg-blue-50 shadow-lg sm:shadow-xl md:shadow-2xl">
...
const Cardi = () => {
    return (
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 mb-4">
        <Card title="Collaboration" content="Full-stack development thrives
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 mb-4 transform translate-y-2">
        <Card title="smart work" content=" amplifies productivity by focusing on efficiency
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 mb-4 transform translate-y-2">
        <Card title="Dedication" content="Being dedicated to role in development ensures excellent
              of a project to its final release. It requires a strong commitment to quality,
              ...
              ensuring that every aspect of the project is polished and functional. " />
      </div>
    </div>
  );
};
